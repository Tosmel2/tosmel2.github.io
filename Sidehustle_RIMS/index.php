...
?>
    <!-- Page Content -->
    <div class="container-fluid superContainer">
	  <div class="row">
		<div class="col-lg-2 sidebar">
		<h1 class="my-4"></h1>
			<div class="nav mt-5 flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Food Items</a>
			  ...
			  <a class="nav-link" id="v-pills-vendor-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Orders</a>
			  ...
			  <a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false">Customer Report</a>
			</div>
		</div>
		 <div class="col-lg-10">
